...
const HomePage: React.FC<HomePageProps> = ({ isVisible }) => {
  ...
  return (
    <div className="relative w-full h-full min-h-dvh flex items-center justify-center overflow-y-auto">
      {/* Silk Background */}
      <SilkBackground />
      ...
      <div className={`absolute left-1/2 transform -translate-x-1/2 z-10 transition-all duration-700 ease-out hidden sm:block ${
        ...
        <div className="px-4 py-2 font-sans text-xs font-medium rounded-full transition-all duration-300 hover:scale-105 cursor-pointer bg-stone-900/40 text-stone-400 embossed-subtle-dark hover:bg-stone-900/60 hover:text-stone-300">
      ...
      <div className={`absolute z-10 transition-all duration-700 ease-out delay-150 ${
        ...
        <div className="px-3 py-2 rounded-full transition-all duration-300 hover:scale-105 bg-stone-900/40 embossed-subtle-dark hover:bg-stone-900/60">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></div>
            <span className="text-xs font-medium transition-colors duration-300 text-stone-400">
              Available
            </span>
          </div>
        </div>
      ...
      <div className={`absolute z-10 transition-all duration-700 ease-out delay-375 ${
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 hover:scale-105 text-stone-400 hover:text-stone-300 bg-stone-900/40 embossed-subtle-dark hover:bg-stone-900/60"
        >
      ...
      <div className="flex flex-col items-center justify-center h-full px-4 relative z-0 -mt-16 pt-16 pb-16 sm:pt-0 sm:pb-0">
          ...
          <div className={`space-y-3 transition-all duration-1000 ease-out delay-450 ${
            ...
            <div className="flex justify-center mb-3">
              <div className="relative">
                {/* Tooltip */}
                <div
                  className={`absolute -top-10 left-1/2 transform -translate-x-1/2 px-2 py-1 rounded text-xs font-medium whitespace-nowrap pointer-events-none transition-all duration-200 z-20 bg-stone-800/90 text-stone-200 shadow-lg ${
                    isHoveringAvatar
                ...
                >
                  ...
                  {/* Arrow */}
                  <div
                    className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-[4px] border-r-[4px] border-t-[4px] border-l-transparent border-r-transparent border-t-stone-800/90"
                  />
                </div>
                ...
                <button
                  ...
                  className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden transition-all duration-300 hover:scale-105 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 ring-2 ring-stone-700/50 shadow-xl focus:ring-stone-500 focus:ring-offset-stone-900"
                  aria-label="View bio"
                >
                  <img 
                    src="/me.png" 
            ...
            <div className="relative">
              ...
              <button
                ...
                className="text-5xl sm:text-6xl md:text-7xl font-sf-display-medium tracking-tight transition-all duration-300 hover:scale-105 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg px-2 py-1 text-stone-100 hover:text-stone-200 focus:ring-stone-500 focus:ring-offset-stone-900"
                aria-label="View bio"
              >
                Daniel Zverev
              </button>
        ...
        <div className={`flex flex-row items-center justify-center gap-3 -mt-4 transition-all duration-700 ease-out delay-700 ${
          animationStage >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            ...
            <a 
              href="mailto:admin@blackcubesolutions.com" 
              className="px-6 py-3 rounded-full font-medium text-sm transition-all duration-300 hover:scale-105 bg-stone-100/90 text-stone-900 embossed-subtle-light hover:bg-white"
            >
              Get In Touch
            </a>
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="px-6 py-3 rounded-full font-medium text-sm transition-all duration-300 hover:scale-105 text-stone-400 hover:text-stone-300 bg-stone-900/40 embossed-subtle-dark hover:bg-stone-900/60"
            >
              Schedule a Call
            </a>
          </div>
