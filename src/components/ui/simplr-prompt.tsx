...
export const SimplrPrompt: React.FC<SimplrPromptProps> = ({ onClose }) => {
  ...
  return (
    <div 
      ...
      /* Mobile: bottom center with proper centering */
      bottom-4 left-1/2 transform -translate-x-1/2 sm:left-auto sm:right-6 sm:transform-none sm:translate-x-0
      `}
    >
      <div 
        className={`relative max-w-sm w-full rounded-2xl p-4 transition-all duration-300 ${
          theme === 'dark'
